const LandStakingContractMainnet = {
  abi: [
    {
      anonymous: false,
      inputs: [
    ...
    },
    {
      ...
      outputs: [
        { internalType: "uint256", name: "newClaimedTickets", type: "uint256" },
      ],
      stateMutability: "view",
      type: "function",
    },
    {
      ...
      outputs: [
        ...
        { internalType: "uint256", name: "startTime", type: "uint256" },
        { internalType: "uint256", name: "endTime", type: "uint256" },
        { internalType: "uint256", name: "ruffleTime", type: "uint256" },
      ],
      stateMutability: "view",
      type: "function",
    },
      ...
      outputs: [
        {
          components: [
            ...
            { internalType: "uint256", name: "size", type: "uint256" },
            { internalType: "string", name: "rarity", type: "string" },
            { internalType: "uint256", name: "xTickets", type: "uint256" },
          ],
      ...
      outputs: [
        {
          components: [
            ...
            { internalType: "uint256", name: "unStakedAt", type: "uint256" },
            { internalType: "uint256", name: "tokenId", type: "uint256" },
            {
              internalType: "address",
              name: "landCollection",
            ...
            { internalType: "string", name: "rarity", type: "string" },
            { internalType: "uint256", name: "xTickets", type: "uint256" },
            { internalType: "bool", name: "isAppliedFor", type: "bool" },
          ],
    ...
    },
    {
      inputs: [
        ...
        { internalType: "uint256", name: "endTime", type: "uint256" },
        { internalType: "uint256", name: "rewardCount", type: "uint256" },
        { internalType: "address", name: "_awardCollection", type: "address" },
      ],
      name: "startLootBox",
      outputs: [],
      stateMutability: "nonpayable",
  ...
  address: "0x73460e9b7e8a837b968120c3d7c264b2f62b99dc",
  
};

const LandStakingContractTestnet = {
  abi: [
    {
      anonymous: false,
      inputs: [
  ...
  address: "0xE3E438fFC458330d096cEf6bbC423f95976363Ad",
};

export const LandStakingContract =
  process.env.NEXT_PUBLIC_NETWORK_TYPE == "testnet"
    ? LandStakingContractTestnet
    : LandStakingContractMainnet;
