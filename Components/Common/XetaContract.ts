const XetaContractMainnet = {
  abi: [
    ...
    {
      anonymous: false,
      inputs: [{ indexed: false, name: "limitNum", type: "uint256" }],
      name: "ChangeTransferLimit",
      type: "event",
    },
    {
...
const XetaContractTestnet = {
  ...
  address: "0xD4d3d5D9F16EC127b01de1803D01a7323F3A7e1b",
};

export const XetaContract =
